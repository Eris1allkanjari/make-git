...
def repo_file(repo, *path, mkdir=False):
    "Same as repo_path , but create dirname(*path) if absent. For example , repo_file(r,\"refs\",\"origin\" , \"HEAD\") will create .git\refs\remotes\origin."""
...
class GitTree(GitObject):
    ...
    def cmd_checkout(args):
        ...
        #verify that path is and empty directory    
...
def ref_list(repo,path=None):
        ...
        #git shows refs sorted. To do the same we use OrderedDict
...
This function is aware of:
 ...
 if hashRE.match(name):
        if len(name) == 40:
            ...
            #min length of small hash is 4 to consider it a small hash . This is documented in man git-rev-parse 
            name = name.lower()
            prefix = name[0:2]
